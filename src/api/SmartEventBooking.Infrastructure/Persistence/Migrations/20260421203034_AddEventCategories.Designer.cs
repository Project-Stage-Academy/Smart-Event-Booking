...
namespace SmartEventBooking.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260421203034_AddEventCategories")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartEventBooking.Domain.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartEventBooking.Domain.Entities.EventCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SmartEventBooking.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("SmartEventBooking.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SmartEventBooking.Domain.Entities.EventCategory", b =>
                {
                    b.HasOne("SmartEventBooking.Domain.Entities.Category", "Category")
                        .WithMany("EventCategories")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SmartEventBooking.Domain.Entities.Event", "Event")
                        .WithMany("EventCategories")
            ...
            modelBuilder.Entity("SmartEventBooking.Domain.Entities.User", b =>
                {
                    b.HasOne("SmartEventBooking.Infrastructure.Identity.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("SmartEventBooking.Domain.Entities.User", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
